...
NOTIF_I18N = {
    "en": {
        ...
        "digest_requests": "📋 Pending requests: <b>{n}</b>",
    ...
    "ru": {
        ...
        "digest_requests": "📋 Заявок в ожидании: <b>{n}</b>",
    ...
    "tr": {
        ...
        "digest_requests": "📋 Bekleyen talepler: <b>{n}</b>",
    ...
    "uz": {
        ...
        "digest_requests": "📋 Kutilayotgan so'rovlar: <b>{n}</b>",
